...
/**
 * A close component to the JTabbedPane in MainView Contains a JLabel to show
 * the name of the document (yet to be implemented) and a JButton to close the
 * tab it belongs to
 */
...
public class ButtonTabClose extends JPanel {
	...
	private class TabButton extends JButton implements ActionListener {
		...
		/**
		 * Paint the close tab button with the help of 2 dimensional graphics
		 * 
		 * @see javax.swing.JComponent#paintComponent(java.awt.Graphics) for
		 *      more information about 2D graphics
		 */
