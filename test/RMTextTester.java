...
public class RMTextTester {
	...
	public void testChangeFont() {	
		...
		String ViewFont = p.getOtherText().getFont().getName();
	...
	public void testChangeSize() {
		...
		int ViewSize = p.getOtherText().getFont().getSize();
	...
	public void testChangeStyle() {
		 ...
		 */
		String style = "U";
		p.changeStyle(p.getOtherText(), style);
	...
	public void testReplaceText() {
		p.getOtherText().setText("It's a test");
		p.replaceText("It's", "was", p.getOtherText());
		String ModelText = t.getText();
		String ViewText = p.getOtherText().getText();
