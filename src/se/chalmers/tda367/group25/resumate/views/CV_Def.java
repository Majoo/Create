				...
				.addGroup(Alignment.LEADING, groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup()
							.addComponent(getEducationText(), GroupLayout.PREFERRED_SIZE, 337, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED, 20, Short.MAX_VALUE)
							.addComponent(getImageLabel(), GroupLayout.PREFERRED_SIZE, 130, GroupLayout.PREFERRED_SIZE)
							.addGap(52))
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(getWorkExpHeader(), GroupLayout.PREFERRED_SIZE, 437, GroupLayout.PREFERRED_SIZE)
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(getEducationText(), GroupLayout.PREFERRED_SIZE, 179, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(getWorkExpHeader(), GroupLayout.PREFERRED_SIZE, 48, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
