 ...
 * accesing the text in the different fields, for styling the text in the text
 * areas and basic functions involving writing.
 */
public abstract class TemplatePanel extends JPanel implements FocusListener {
	// Textfields with personal info titles
	private JTextField nameTitle, cityzipcodeTitle, addressTitle, phoneTitle,
			emailTitle;

	// Empty textfields with personal info
	private JTextField nameField, cityzipcodeField, addressField, phoneField,
			emailField, empty1Field, empty2Field;
	...
	private List<JTextComponent> allTextComponents = new ArrayList<JTextComponent>(
			nbrOfAllComponents - 1);

	/**
	 * Create the template panel. Is invoked in subclasses with the proper
	 * JTextPanes. Setting all textfields.
	 */
	public TemplatePanel() {
		...
		cityzipcodeTitle.setBorder(BorderFactory
		...
		cityzipcodeField.setBorder(BorderFactory
				.createDashedBorder(Color.BLACK));
		...
		getEduHeader()
				.setToolTipText(
						"<html>Headline for your education experiences. <br><b>Protip!</b><br> Instead of <i>Education</i> you could use something more creative. <br> But be careful to not be too informal.</html>");
		getEduHeader().setText("[EDUCATION HEADLINE]");
		getWorkingExperienceText()
				.setToolTipText(
						"<html>Enter the work experiences you've got. "
		...
		getCityField().setToolTipText(
				"Enter the current city and zipcode you're living in.");
		getAddressField().setToolTipText("Enter your home address.");
		getEmailField()
				.setToolTipText(
						"<html>Enter the email account that you are <br>most active at so the employer can contact you.</html>");
		getPhoneField()
				.setToolTipText(
						"<html>Enter a phone number where <br>your employer can  reach you anytime.</html>");
		getCurrentSection().setToolTipText(
				"Enter your full name (first, mid and last name)");
		getWorkExpHeader().setText("[HEADLINE]");
		getWorkExpHeader()
				.setToolTipText(
						"<html><b>Protip!</b> Use a creative headline to attract your employer!</html>");
		getImageLabel()
				.setToolTipText(
						"<html>This is where your picture will be located. <br><b>Protip!</b> Use a face frontal picture with good quality.</html>");
		getEmptyField2().setToolTipText(
				"<html>Write down whatever you want. <br>"
						+ "<b>Protip!</b> Your twitter account?</html>");
		getEmptyField1().setToolTipText(
				"<html>Write down whatever you want. <br>"
		...
		getCityTitle().setToolTipText(
				"Fill in the name of your city and the zipcode.");
	 ...
	 * 
	 * @return the JTextField that indicates the user to write their name.
	 */
	 ...
	 * 
	 * @return the JTextField that indicates the user to write their address.
	 */
	 ...
	 * 
	 * @return the JTextField that indicates the user to write their
	 *         City/Zipcode.
	 */
	 ...
	 * 
	 * @return the JTextField that indicates the user to write their phone
	 *         number.
	 */
	 ...
	 * 
	 * @return the JTextField where the user usually writes their name.
	 */
	 ...
	 * 
	 * @return the JTextField where the user usually writes their address.
	 */
	 ...
	 * 
	 * @return the JTextField where the user usually writes their city.
	 */
	 ...
	 * 
	 * @return the JTextField where the user usually writes their phone number.
	 */
	 ...
	 * 
	 * @return the JTextField where the user usually writes their mail address.
	 */
	 ...
	 * 
	 * @return the JTextField where the user can write whatever they like.
	 */
	 ...
	 * 
	 * @return the header (headline) for writing "Education".
	 */
	 ...
	 * 
	 * @return the header (headline) for writing "Work Experience".
	 */
	 ...
	 * 
	 * @return the Working Experience Text
	 */
	 ...
	 * 
	 * @return all the text components
	 */
	...
	/**
	 * Sets the current section which is the one currently in focus. Informs the
	 * controller that the text area has changed so that the view may be
