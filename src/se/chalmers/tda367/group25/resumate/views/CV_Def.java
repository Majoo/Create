...
public class CV_Def extends TemplatePanel {
	...
	public CV_Def() {
		...
		gl_pnlPersonalInfo
				.setHorizontalGroup(gl_pnlPersonalInfo
						.createParallelGroup(Alignment.LEADING)
						.addGroup(
								gl_pnlPersonalInfo
										.createSequentialGroup()
										...
										.addContainerGap(
												...
												Short.MAX_VALUE)));
		gl_pnlPersonalInfo
				.setVerticalGroup(gl_pnlPersonalInfo
						.createParallelGroup(Alignment.LEADING)
						.addGroup(
								gl_pnlPersonalInfo
										.createSequentialGroup()
										...
										.addPreferredGap(
												ComponentPlacement.RELATED)
										.addComponent(getEmptyField1(),
												GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(
												ComponentPlacement.RELATED)
										.addComponent(getEmptyField2(),
												GroupLayout.PREFERRED_SIZE, 16,
												GroupLayout.PREFERRED_SIZE)
